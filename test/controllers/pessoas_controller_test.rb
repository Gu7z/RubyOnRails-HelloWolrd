...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { altura: @pessoa.altura, idade: @pessoa.idade, name: @pessoa.name } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { altura: @pessoa.altura, idade: @pessoa.idade, name: @pessoa.name } }
